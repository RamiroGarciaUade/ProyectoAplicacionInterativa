...
public class ControllerUser {
    ...
    public ResponseEntity<Optional<User> > getUserByUserEmail(@PathVariable String email) {
    ...
    public ResponseEntity<?> createUser(@RequestBody User user) {
        try {
            ...
            // Respuesta exitosa
            return ResponseEntity.ok(Map.of("userName", createdUser.getFirstName()));
    ...
    public ResponseEntity<?> loginUser(@RequestBody UserRequest loginRequest) {
        ...
        if (user.isPresent() && user.isPresent() && user.get().getPassword().equals(loginRequest.getPassword())) {
            return ResponseEntity.ok(user.get()); // mal token
        } else {
    ...
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody User updatedUser) {
        ...
        if (userOptional.isPresent()) {
            ...
            existingUser.setImageType(updatedUser.getImageType());
